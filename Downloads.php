...
<ul id="Binaries" name="Binaries">
    ...
    <p class="p_extra_spaced">
        ...
        &nbsp;<a href="https://github.com/falkTX/Carla/releases/download/v1.9.13/Carla_2.0-RC3-linux32.tar.xz" class="external text a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_carla.png" alt="" class="img_text_align"/> Carla2 </a> (32bit, version 2.0-RC3)<br/>
        &nbsp;<a href="https://github.com/falkTX/Carla/releases/download/v1.9.13/Carla_2.0-RC3-linux64.tar.xz" class="external text a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_carla.png" alt="" class="img_text_align"/> Carla2 </a> (64bit, version 2.0-RC3)<br/>
    ...
    <p class="p_extra_spaced">
        ...
        &nbsp;<a href="https://github.com/falkTX/Carla/releases/download/v1.9.13/Carla_2.0-RC3-macos.dmg" class="external text a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_carla.png" alt="" class="img_text_align"/> Carla2 </a> (version 2.0-RC3 for macOS 10.8 or higher)<br/>
    </p>
    <p class="p_extra_spaced">
        ...
        &nbsp;<a href="http://sourceforge.net/projects/kxstudio/files/Releases/cadence/Cadence-0.8.1-win32.zip/download" class="external text a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_cadence.png" alt="" class="img_text_align"/> Cadence </a> (32bit, version 0.8.1)<br/>
        &nbsp;<a href="https://github.com/falkTX/Carla/releases/download/v1.9.13/Carla_2.0-RC3-win32.zip" class="external text a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_carla.png" alt="" class="img_text_align"/> Carla2 </a> (32bit, version 2.0-RC3)<br/>
        &nbsp;<a href="https://github.com/falkTX/Carla/releases/download/v1.9.13/Carla_2.0-RC3-win64.zip" class="external text a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_carla.png" alt="" class="img_text_align"/> Carla2 </a> (64bit, version 2.0-RC3)<br/>
    </p>
</ul>
...
<ul id="SourceCode" name="SourceCode">
    ...
    <p class="p_extra_spaced">
        ...
        &nbsp;<a href="https://github.com/falkTX/Carla/archive/v1.9.13.tar.gz" class="external free a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_carla.png" alt="" class="img_text_align"/> Carla2 </a> (version 2.0-RC3)<br/>
