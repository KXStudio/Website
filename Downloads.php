...
<ul id="Binaries" name="Binaries">
    ...
    <p class="p_extra_spaced">
        ...
        &nbsp;<a href="http://sourceforge.net/projects/kxstudio/files/Releases/carla/Carla-2.0beta2-linux32.tar.xz/download" class="external text a_bigger_text" rel="nofollow" target="_blank">
              <img src="images/ico_carla.png" alt="" class="img_text_align"/> Carla2 </a> (32bit, version 2.0-beta2)<br/>
        &nbsp;<a href="http://sourceforge.net/projects/kxstudio/files/Releases/carla/Carla-2.0beta2-linux64.tar.xz/download" class="external text a_bigger_text" rel="nofollow" target="_blank">
